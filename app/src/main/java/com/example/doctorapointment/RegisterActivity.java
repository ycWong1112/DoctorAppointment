...
public class RegisterActivity extends AppCompatActivity {
    ...
    private TextView haveAcc, getLocation,registerAsDoctor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerAsDoctor = findViewById(R.id.tvRegisterAsDoctor);
        ...
        registerAsDoctor.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view) {
                Intent loginIntent = new Intent(RegisterActivity.this, RegisterDoctorActivity.class);
                startActivity(loginIntent);
                finish();
                overridePendingTransition(0,0);
            }
    ...
    private class AddressResultReceiver extends ResultReceiver {
        ...
        protected void onReceiveResult(int resultCode, Bundle resultData) {
            ...
            if (resultCode == FetchAddressConstants.SUCCESS_RESULT) {
                ...
                Toast.makeText(RegisterActivity.this, resultData.getString(FetchAddressConstants.RESULT_DATA_KEY), Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    private Boolean checkUserValidation() {
        ...
        if(userName.isEmpty() && userEmail.isEmpty() && userPhoneNo.isEmpty() && userAddress.isEmpty() && userPassword.isEmpty() && userConfirmPw.isEmpty()){
            ...
            Toast.makeText(RegisterActivity.this, "Password must contain special characters, upper case, lower case, number and at least 8 characters long.", Toast.LENGTH_LONG).show();
        }
            ...
            firebaseUser.sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if(task.isSuccessful()){
                        ...
                        progressDialog.dismiss();
                        Toast.makeText(RegisterActivity.this, "Failed to send verification.", Toast.LENGTH_LONG).show();
                    }
                }
            });
        }
                            ...
                            databaseReference.child(firebaseAuth.getUid()).setValue(hashMap)
                                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                                        ...
                                        public void onSuccess(Void aVoid) {
                                            //updated
                                            progressDialog.dismiss();
                                            Toast.makeText(RegisterActivity.this, "Registered. Please verify your account via Email.", Toast.LENGTH_SHORT).show();
