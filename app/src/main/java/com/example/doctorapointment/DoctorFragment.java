...
public class DoctorFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        patientList = view.findViewById(R.id.btnlistPatients);
        patRequest = view.findViewById(R.id.btnPatientRequest);
        myCalendar = view.findViewById(R.id.btnmyCalendar);

        myCalendar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getActivity(),MyCalendarDoctorActivity.class);
